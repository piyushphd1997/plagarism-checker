<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="~/admin/NotDoneUser.aspx.cs" Inherits="admin_ViewDetails" %>
        ...
        <tr>
            <td style="height: 23px">
                ...
                <asp:SqlDataSource ID="SqlDataDonorData" runat="server" 
                    ...
                    SelectCommand="select * from Registration where id!=(select uid from Papers)">
                </asp:SqlDataSource>
            </td>
        </tr>
        </table>
